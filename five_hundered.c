...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/05/10 17:29:54 by bbendiou          #+#    #+#             */
/*   Updated: 2023/05/10 17:30:06 by bbendiou         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "push_swap.h"

void	five_hundered_helper(t_var *var, t_list **stack_a, t_list **stack_b)
{
...
void	five_hundered(t_list **stack_a, t_list **stack_b)
{
	...
	var->range = ((get_max(*stack_a) - var->min) + 1) / 11;
	var->size = lstsize(&(*stack_a));
	while (var->size)
	{
		...
		five_hundered_helper(var, &(*stack_a), &(*stack_b));
	}
